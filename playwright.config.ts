...
// Helper to generate YYYY-MM-DD_HH-mm-ss timestamp
const getReportFolder = () => {
  ...
  return `Reports/html/reports_${timestamp}`;
};
...
export default defineConfig({
  ...
  /* Retry on failure (both local and CI) */
  retries: 2,
  /* Opt out of parallel tests on CI. */
  workers: process.env.CI ? 1 : undefined,
  /* Reporter to use. See https://playwright.dev/docs/test-reporters */
  reporter: [
    ['html', { outputFolder: getReportFolder(), open: 'never' }]
  ],
